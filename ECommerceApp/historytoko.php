                ...
                <div class="row mt-3">
                    ...
                    <div class="col-8">
                        <table border="1" class="table table-striped table-tess rounded">
                            ...
                            <?php
                                $resultItems = mysqli_query($conn,"SELECT ht.ht_us_id,i.it_name,dt.dt_jumlah,i.it_price from h_trans ht join d_trans dt on dt.dt_ht_id=ht_id join items i on i.it_id=dt.dt_it_id join users u on ht.ht_us_id=u.us_id where i.it_us_id='".$_SESSION["userlogin"]."' order by it_name asc");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?=$row[3]*$row[2]?></td>
                                    <td><?php
                                    $namaseller = mysqli_query($conn,"SELECT us_name FROM users where us_id='".$row[0]."'");
